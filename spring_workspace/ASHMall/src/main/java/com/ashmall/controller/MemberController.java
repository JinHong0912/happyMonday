...
public class MemberController {
	...
	*/
	...
	public String checkPwdPost(@RequestParam("url") String url,
								@RequestParam("mb_password") String pw,
								HttpSession session, Model model) throws Exception {
		
		logger.info("=====checkPw() execute...");
		logger.info("=====url: " + url + ", mb_password:" + pw);

		MemberDTO dto = (MemberDTO)session.getAttribute("user");

		if(passwdEncrypt.matches(pw, dto.getMb_password())) {
